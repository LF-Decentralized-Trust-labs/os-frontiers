...
GrimoireLab is one of the most battle-tested open source community health platforms in existence, with over a decade of production use across some of the world's largest open source foundations.
...
- Live platform: https://chaoss.github.io/grimoirelab/
- Cauldron (hosted SaaS on GrimoireLab): https://cauldron.io

## Related Projects
- CHAOSS Augur (alternative CHAOSS analytics platform)
- Bitergia Analytics (commercial platform built on GrimoireLab)
- LFX Insights (Linux Foundation analytics built on GrimoireLab)
...
## Primary Contact
- Bitergia / CHAOSS Community — Website: [https://chaoss.community](https://chaoss.community)
...
- Linux Foundation CHAOSS community contributors (150+ developers)
